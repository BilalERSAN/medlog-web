...
const initialStories: Story[] = [
  {
    ...
    quote: { en: "The guidance provided through Curelog gave me clarity during a confusing time. Their neurological focus and compassionate approach gave me the confidence I needed for my recovery journey. Before reaching out, I had visited three different clinics and no one could pinpoint the exact cause of my chronic migraines. Through the shared experiences on this platform, I was able to find the right direction. The surgery was a complete success, and the post-operative support was beyond anything I had ever experienced. I am now completely pain-free for the first time in six years.", ar: "أعطاني التوجيه المقدم من خلال كيورلوج وضوحاً خلال وقت مربك. تركيزهم العصبي ونهجهم العطوف أعطاني الثقة التي كنت أحتاجها لرحلة التعافي. قبل التواصل معهم، زرت ثلاث عيادات مختلفة ولم يتمكن أحد من تحديد السبب الدقيق للصداع النصفي المزمن الذي أعاني منه. من خلال التجارب المشتركة على هذه المنصة، تمكنت من العثور على الاتجاه الصحيح. كانت الجراحة ناجحة تماماً، وكان دعم ما بعد الجراحة يفوق أي شيء جربته على الإطلاق. أنا الآن خالية تماماً من الألم لأول مرة منذ ست سنوات." },
  ...
  },
  {
    ...
    quote: { en: "I've always had anxiety about dental procedures, but the gentle approach and state-of-the-art facilities recommended through Curelog completely changed my perspective. I finally have the perfect smile.", ar: "كنت دائماً أشعر بالقلق من إجراءات الأسنان، لكن النهج اللطيف والمرافق الحديثة الموصى بها من خلال كيورلوج غيرت وجهة نظري تماماً. لدي أخيراً الابتسامة المثالية." },
